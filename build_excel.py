...
data = [
    ...
    (24, "Carolina Herrera",  "Bad Boy Cobalt EDP",             "Hombre", 100, "Pimienta, sabio, plum, cedro, vainilla. Más frutal e intenso.",             7500, None, "SI", "NO", IMG(78562)),
    (25, "Carolina Herrera",  "CH Men EDT",                     "Hombre", 100, "Pomelo, lavanda, canela, cuero. Elegante, sofisticado.",                    5600, None, "SI", "NO", IMG(1121)),
    ...
    (33, "Hugo Boss",         "Hugo Man EDT",                   "Hombre", 125, "Menta, manzana verde, lavanda, abeto. Fresco juvenil icónico.",             4200, None, "SI", "NO", IMG(322)),
    ...
    (36, "Calvin Klein",      "Eternity Men EDT",               "Hombre", 100, "Lavanda, geranio, cedro, sándalo. Aromático clásico noventero.",            5200, None, "SI", "NO", IMG(379)),
    (37, "Calvin Klein",      "CK One EDT",                     "Unisex", 200, "Limón, bergamota, papaya, té verde. Unisex fresco icónico.",                4200, None, "SI", "NO", IMG(387)),
    (38, "Calvin Klein",      "Obsession for Men EDT",          "Hombre", 125, "Mandarina, lavanda, amberes, almizcle. Oriental especiado 80s.",           4600, None, "SI", "NO", IMG(373)),
    ...
    (42, "Versace",           "Pour Homme EDT",                 "Hombre", 100, "Bergamota, neroli, clary sage, cedro. Fresco aromático mediterráneo.",      5800, None, "SI", "NO", IMG(1340)),
    (43, "Azzaro",            "Wanted EDT",                     "Hombre", 100, "Limón, pimienta, cardamomo, cuero, vetiver. Especiado carismático.",        5800, None, "SI", "NO", IMG(41459)),
    (44, "Azzaro",            "Chrome EDT",                     "Hombre", 100, "Limón, bergamota, jazmín, almizcle. Fresco acuático.",                      5200, None, "SI", "NO", IMG(380)),
    (45, "Tommy Hilfiger",    "Tommy EDT",                      "Hombre", 100, "Lavanda, manzana, menta, cuero. Fresco americano casual.",                  4500, None, "SI", "NO", IMG(430)),
    (46, "Nautica",           "Voyage EDT",                     "Hombre", 100, "Manzana, loto, abeto, musgo. Acuático aromático fresco.",                   3800, None, "SI", "NO", IMG(1131)),
    ...
    (49, "Yves Saint Laurent","Y EDP",                          "Hombre", 100, "Manzana, jengibre, salvia, ambroxan. Fresco amaderado moderno.",            8200, None, "SI", "NO", IMG(49330)),
    (50, "Yves Saint Laurent","L'Homme EDT",                    "Hombre", 100, "Jengibre, bergamota, cedro, tonka. Elegante masculino.",                    7800, None, "SI", "NO", IMG(633)),
    ...
    (54, "Chanel",            "No. 5 EDP",                      "Mujer",  100, "Aldehídos, ylang-ylang, rosa mayo, jazmín, vainilla, sándalo. Legendario.", 12500, None, "SI", "NO", IMG(538)),
    (55, "Chanel",            "Coco Noir EDP",                  "Mujer",  100, "Bergamota, rosa, jazmín, pachulí, tonka. Oriental profundo nocturno.",     11000, None, "SI", "NO", IMG(14991)),
    (56, "Lancôme",           "Idôle EDP",                      "Mujer",   75, "Pera, bergamota, rosa, jazmín, almizcle blanco. Floral chypre ligero.",     8500, None, "SI", "NO", IMG(55795)),
    (57, "Lancôme",           "Miracle EDP",                    "Mujer",  100, "Jengibre, pimienta, lychee, magnolia, jazmín, almizcle. Fresco floral.",    7800, None, "SI", "NO", IMG(544)),
    (58, "Lancôme",           "La Vie Est Belle Intensément",   "Mujer",  100, "Iris, pera, jazmín, vainilla, pachulí. Más intenso que el original.",       9800, None, "SI", "NO", IMG(63155)),
    ...
    (61, "Carolina Herrera",  "CH Women EDP",                   "Mujer",  100, "Pomelo, bergamota, rosa, ámbar, cuero. Elegante clásico.",                  5800, None, "SI", "NO", IMG(1120)),
    (62, "Carolina Herrera",  "212 Women NYC EDT",              "Mujer",  100, "Mandarina, flor de loto, bambú, sándalo. Fresco urbano limpio.",            5500, None, "SI", "NO", IMG(298)),
    ...
    (66, "Yves Saint Laurent","Mon Paris EDP",                  "Mujer",   90, "Fresa, pera, peonía, jazmín, pachulí. Floral frutal chypre moderno.",       9200, None, "SI", "NO", IMG(38552)),
    (67, "Dior",              "J'adore EDP",                    "Mujer",  100, "Pera, magnolia, jazmín sambac, rosa, vainilla. Floral icónico luminoso.",  12500, None, "SI", "NO", IMG(210)),
    (68, "Dior",              "Miss Dior EDP",                  "Mujer",  100, "Rosa grasse, lily of the valley, pachulí. Floral romántico moderno.",      11500, None, "SI", "NO", IMG(45200)),
    (69, "Dior",              "Poison Girl EDP",                "Mujer",  100, "Pomelo, rosa damascena, almendra amarga, vainilla. Oriental frutal.",      10500, None, "SI", "NO", IMG(35042)),
    ...
    (76, "Calvin Klein",      "Euphoria EDP",                   "Mujer",  100, "Pomelo, granada, flor loto, orquídea, amber, cream accord. Oriental seductor.", 6500, None, "SI", "NO", IMG(1071)),
    (77, "Calvin Klein",      "Eternity Women EDP",             "Mujer",  100, "Freesia, clavel, madreselva, sándalo. Floral clásico.",                     5800, None, "SI", "NO", IMG(375)),
    ...
    (79, "Versace",           "Eros Pour Femme EDP",            "Mujer",  100, "Limón, mandarina, peonía, jazmín, ámbar, sándalo. Floral oriental.",        6800, None, "SI", "NO", IMG(26532)),
    (80, "Hugo Boss",         "Boss Alive EDP",                 "Mujer",   80, "Pera, ciruela, jazmín, vainilla, cedro. Floral moderno femenino.",          5800, None, "SI", "NO", IMG(58537)),
    (81, "Hugo Boss",         "Boss Ma Vie EDP",                "Mujer",   75, "Cactus, rosa, jazmín, sándalo. Verde floral fresco.",                       5500, None, "SI", "NO", IMG(21945)),
    (82, "Tommy Hilfiger",    "Tommy Girl EDT",                 "Mujer",  100, "Manzana, camelia, rosa, lirio, bayas silvestres. Americana fresca.",        4800, None, "SI", "NO", IMG(434)),
    (83, "Jean Paul Gaultier","La Belle EDP",                   "Mujer",  100, "Pera, vainilla bourbon, habas tonka, flor de sal. Gourmand luminoso.",      7500, None, "SI", "NO", IMG(58493)),
    ...
    (85, "Kenzo",             "Flower by Kenzo EDP",            "Mujer",  100, "Mandarina, grosella negra, violeta, rosa, haba tonka, almizcle blanco.",    6800, None, "SI", "NO", IMG(401)),
    (86, "Nina Ricci",        "Nina EDT",                       "Mujer",   80, "Limón, lima, manzana dulce, peonía, vainilla. Frutal floral gourmand.",     5500, None, "SI", "NO", IMG(147)),
    (87, "Nina Ricci",        "Luna EDT",                       "Mujer",   80, "Pomelo, caramelo, azahar, algodón de azúcar. Frutal dulce joven.",          5200, None, "SI", "NO", IMG(22999)),
    (88, "Bvlgari",           "Omnia Crystalline EDT",          "Mujer",   65, "Bambú, nashi, loto, teca, madreperla. Acuático transparente.",              5800, None, "SI", "NO", IMG(554)),
    (89, "Chloé",             "Chloé EDP",                      "Mujer",   75, "Peonía, lichi, freesia, rosa, magnolia, cedro. Floral rosado icónico.",     9500, None, "SI", "NO", IMG(1077)),
    (90, "Bvlgari",           "Aqva Pour Homme EDT",            "Hombre", 100, "Mandarina, petitgrain, almíbar, musgo marino. Fresco acuático mineral.",    6800, None, "SI", "NO", IMG(549)),
]
